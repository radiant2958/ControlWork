...
def handler(n: int, counter: Counter.Counter,my_animal):
    ...
    match n:
        ...
        case 1:
            try:
                my_animal = model.add_new_animal(my_animal, *View.get_animal_details())
                counter.add(1)
                View.print_counter(counter)
        ...
        case 3:
            ...
            my_animal = model.new_commands(my_animal, View.input_id(), View.new_command())
            View.lesson_command()
        ...
        case 6:
            my_animal=model.delete_animal(my_animal, View.input_id())
            counter.add(-1)
            View.del_animal()
            View.print_counter(counter)
